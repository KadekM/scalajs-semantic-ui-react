...
// ---- dependencies ----
val reactVersion = "1.0.0"
val semanticUiVersion = "2.2.10"
val semanticUiReactVersion = "0.68.3"
...
val jsDeps = Seq(
  ...
  jsDependencies += ("org.webjars.bower" % "react" % reactJsVersion / "react-dom.js")
...
lazy val root = (project in file("."))
  .settings(commonSettings)
  .dependsOn(library, sample).aggregate(library, sample)
